    ...
    <div class="container " data-aos="fade-up" data-aos-delay="100">
        <div class="row featured-products-row" data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="product-showcase ">
                    <div class="product-image">
                        <img src="{{asset('frontend/assets/img/product/product-5.webp')}}" alt="Featured Product"
                             class="img-fluid">
                        <div class="discount-badge">-45%</div>
                    </div>
                    <div class="product-details">
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="150">
                <div class="product-showcase">
                    <div class="product-image">
                        <img src="{{asset('frontend/assets/img/product/product-7.webp')}}" alt="Featured Product"
                             class="img-fluid">
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="product-showcase">
                    <div class="product-image">
                        <img src="{{asset('frontend/assets/img/product/product-11.webp')}}" alt="Featured Product"
                             class="img-fluid">
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="250">
                <div class="product-showcase">
                    <div class="product-image">
                        <img src="{{asset('frontend/assets/img/product/product-1.webp')}}" alt="Featured Product"
                             class="img-fluid">
