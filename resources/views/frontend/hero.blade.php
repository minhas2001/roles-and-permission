    ...
    <div class="hero-container">
                ...
                <div class="product-showcase" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="product-grid">
                        <div class="product-mini" data-aos="zoom-in" data-aos-delay="400">
                            <img src="{{ asset('frontend/assets/img/product/product-3.webp') }}" alt="Product" class="img-fluid">
                            <span class="mini-price">$89</span>
                        </div>
                        <div class="product-mini" data-aos="zoom-in" data-aos-delay="500">
                            <img src="{{ asset('frontend/assets/img/product/product-5.webp') }}" alt="Product" class="img-fluid">
        ...
        @empty
            ...
            <div class="hero-visuals">
                <div class="product-showcase" data-aos="fade-left" data-aos-delay="200">
                    <div class="product-card featured">
                        <img src="{{ asset('frontend/assets/img/product/product-2.webp') }}" alt="Featured Product" class="img-fluid">
                        <div class="product-badge">Best Seller</div>
                        <div class="product-info">
